...
- [Introduction](#introduction)
  - [Why Interface Circuits Matter](#why-interface-circuits-matter)
  - [Interface Architecture Overview](#interface-architecture-overview)
- [Signal Conditioning Basics](#signal-conditioning-basics)
  - [Key Performance Metrics](#key-performance-metrics)
  - [Common Circuit Blocks](#common-circuit-blocks)
- [Capacitive Interface Circuits](#capacitive-interface-circuits)
  - [Charge Amplifier](#charge-amplifier)
  - [Switched-Capacitor Interface](#switched-capacitor-interface)
  - [Continuous-Time Interface](#continuous-time-interface)
  - [Capacitance-to-Digital Converter (CDC)](#capacitance-to-digital-converter-cdc)
- [Piezoresistive Interface Circuits](#piezoresistive-interface-circuits)
  - [Wheatstone Bridge](#wheatstone-bridge)
  - [Instrumentation Amplifier](#instrumentation-amplifier)
  - [Signal Chain Example](#signal-chain-example)
- [Resonant MEMS Interfaces](#resonant-mems-interfaces)
  - [Phase-Locked Loop (PLL)](#phase-locked-loop-pll)
  - [Automatic Gain Control (AGC)](#automatic-gain-control-agc)
- [Actuation Drivers](#actuation-drivers)
  - [Electrostatic Drivers](#electrostatic-drivers)
  - [Electromagnetic Drivers](#electromagnetic-drivers)
  - [Thermal Drivers](#thermal-drivers)
- [Noise and Performance](#noise-and-performance)
  - [Noise Sources](#noise-sources)
  - [Total Noise Budget](#total-noise-budget)
  - [Dynamic Range](#dynamic-range)
- [Power Management](#power-management)
  - [Supply Regulation](#supply-regulation)
  - [Power Consumption](#power-consumption)
- [Design Examples](#design-examples)
  - [Example 1: Accelerometer Interface (Capacitive)](#example-1-accelerometer-interface-capacitive)
  - [Example 2: Pressure Sensor Interface (Piezoresistive)](#example-2-pressure-sensor-interface-piezoresistive)
  - [Example 3: Gyroscope Readout](#example-3-gyroscope-readout)
- [Summary](#summary)
