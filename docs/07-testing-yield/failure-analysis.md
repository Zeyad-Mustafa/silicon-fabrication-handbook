...
- [Introduction](#introduction)
  - [FA Objectives](#fa-objectives)
  - [FA Priority](#fa-priority)
  - [FA Team](#fa-team)
- [FA Process Flow](#fa-process-flow)
  - [Standard FA Flow](#standard-fa-flow)
  - [Documentation Requirements](#documentation-requirements)
- [Non-Destructive Analysis](#non-destructive-analysis)
  - [Visual Inspection](#visual-inspection)
  - [X-Ray Inspection](#x-ray-inspection)
  - [Acoustic Microscopy (SAM)](#acoustic-microscopy-sam)
...
- [Destructive Analysis](#destructive-analysis)
  ...
  - [Energy Dispersive X-ray (EDX)](#energy-dispersive-x-ray-edx)
...
- [Case Studies](#case-studies)
  - [Case Study 1: Accelerometer Offset Drift](#case-study-1-accelerometer-offset-drift)
  - [Case Study 2: Pressure Sensor Package Leak](#case-study-2-pressure-sensor-package-leak)
  - [Case Study 3: RF MEMS Switch Stiction](#case-study-3-rf-mems-switch-stiction)
- [Best Practices](#best-practices)
  - [FA Lab Setup](#fa-lab-setup)
  - [FA Guidelines](#fa-guidelines)
