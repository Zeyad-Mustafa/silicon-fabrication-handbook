...
- [Introduction](#introduction)
  - [SPC Objectives](#spc-objectives)
  - [Key Concepts](#key-concepts)
- [Control Charts](#control-charts)
  - [X-bar and R Charts](#x-bar-and-r-charts)
  - [Individuals and Moving Range (I-MR) Charts](#individuals-and-moving-range-i-mr-charts)
  - [Control Chart Rules (Western Electric Rules)](#control-chart-rules-western-electric-rules)
  - [p-Chart (Proportion Defective)](#p-chart-proportion-defective)
  - [c-Chart (Count of Defects)](#c-chart-count-of-defects)
- [Process Capability](#process-capability)
  - [Capability Indices](#capability-indices)
  - [Pp and Ppk (Process Performance)](#pp-and-ppk-process-performance)
...
- [SPC Implementation](#spc-implementation)
  ...
  - [Critical Parameters for SPC](#critical-parameters-for-spc)
  - [Data Collection Methods](#data-collection-methods)
  - [Response Procedures](#response-procedures)
- [Advanced Techniques](#advanced-techniques)
  - [Multivariate SPC](#multivariate-spc)
  - [EWMA (Exponentially Weighted Moving Average)](#ewma-exponentially-weighted-moving-average)
  - [CUSUM (Cumulative Sum)](#cusum-cumulative-sum)
  - [SPC Software](#spc-software)
- [Case Study: SPC Implementation](#case-study-spc-implementation)
  - [Etch Rate Control](#etch-rate-control)
- [Best Practices](#best-practices)
  - [SPC Guidelines](#spc-guidelines)
