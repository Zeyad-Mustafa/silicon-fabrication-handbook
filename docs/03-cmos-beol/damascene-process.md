...
**What It Shows**:
The simulator generates a comprehensive visualization (`damascene_process_complete.png`) that includes:
...
**Last Updated**: November 2025  V.2 (python updated with damascene_process_complete.png)
